...
@section('content')
    <section class="banner container-fluid text-center" style="background: url({{asset('assets/images/banner.jpg')}})">
    ...
    <section class="container">
        <div class="py-5">
            <h2 class="pb-2 border-bottom">Aqui vamos falar sobre as funcionalidades</h2>
            <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
                <div class="feature col text-center">
                    <div class="feature-icon d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-2 mb-3">
                        <svg class="bi" width="1em" height="1em"><use xlink:href="#collection"/></svg>
                    </div>
                    <h3 class="fs-2">Gerenciamento</h3>
                    <p>Gerenciamento de todos suas categorias, produtos e pedidos.</p>
                ...
                <div class="feature col text-center">
                    ...
                    <h3 class="fs-2">Perfil Custommizado</h3>
                    <p>Configure sua loja com cronograma de funcionamento, logo e banner.</p>
                    <a href="#" class="icon-link d-inline-flex align-items-center">
                        Call to action
                        <svg class="bi" width="1em" height="1em"><use xlink:href="#chevron-right"/></svg>
                    </a>
                ...
                <div class="feature col text-center">
                    ...
                    <h3 class="fs-2">Configuração de frete</h3>
                    <p>Configure o valor de frete para o bairro que deseja entregar.</p>
                    <a href="#" class="icon-link d-inline-flex align-items-center">
                        Call to action
                        <svg class="bi" width="1em" height="1em"><use xlink:href="#chevron-right"/></svg>
                    </a>
    ...
    <section class="container plans">
        <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
            ...
            <p class="fs-5 text-muted">Listagem dos planos do delivery</p>
        </div>
    ...
    <section class="depoiments container marketing">
        <h2 class="pb-2 border-bottom">Depoimentos</h2>
        <div class="row">
            <div class="col-lg-4">
                <svg class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#777"/><text x="50%" y="50%" fill="#777" dy=".3em">140x140</text></svg>
                <h2 class="fw-normal">Breno Mol</h2>
                <p>Excelente sistema onde posso gerenciar todos meus pedidos.</p>
